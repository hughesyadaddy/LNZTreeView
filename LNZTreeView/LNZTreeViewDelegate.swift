...
@objc public protocol LNZTreeViewDelegate {
     ...
     */
    func treeView(_ treeView: LNZTreeView, didSelectNodeAt indexPath: IndexPath, didSelectIndexPath ogIndexPath: IndexPath, forParentNode parentNode: LNZTreeView.MinimalTreeNode?)
    
    func treeView(_ treeView: LNZTreeView, didDeselectNodeAt indexPath: IndexPath, forParentNode parentNode: LNZTreeView.MinimalTreeNode?)
}
